...
**Renderer note:** when a document mixes page sizes/orientations, `scripts/render_docx.py` computes DPI from the first section. If you care about exact pixel sizes, pass an explicit `--dpi`.
