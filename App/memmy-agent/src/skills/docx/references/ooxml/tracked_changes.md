...
- This skill records `w:date` for chronology and intentionally omits reviewer identity metadata.
...
```xml
<w:del w:id="202" w:date="...">
  <w:r><w:delText> old text </w:delText></w:r>
</w:del>
<w:ins w:id="203" w:date="...">
...
## Verification
- Render to PDF/PNG for layout sanity (`references/tasks/verify_render.md`)
